...
<div class="container">
        ...
        <br>
        <div id = kp><h1 class="text-center pt-4" style="color:white"><b>Transfer Money</b></h1></div>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="selecte_user.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
